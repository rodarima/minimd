...
class Atom
{
  public:
    ...
    // DSM Multibox: the local ID for this box on this process. Will be in range 0->boxes_per_process-1. Not a global ID
    int box_id;
    // DSM: Multibox change. The box IDs of the neighbours for this box
