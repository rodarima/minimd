...
int read_lammps_data(
    Atom &atom, Comm &comm, Neighbor &neighbor, Integrate &integrate, Thermo &thermo, char *file, int units);
...
int main(int argc, char **argv)
{
    ...
    int halfneigh = 1; // 1: use half neighborlist; 0: use full neighborlist; -1: use original miniMD version half
                       // neighborlist force
    int teams = 1;
    int device = 0;
    int neighbor_size = -1;
